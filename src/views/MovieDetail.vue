...
const fetchMovieDetails = async () => {
  ...
  try {
    ...
    const [detailsRes, videosRes] = await Promise.all([
      axios.get(`https://kugis-production.up.railway.app/api/view/details?id=${route.params.id}`),
      axios.get(`https://kugis-production.up.railway.app/api/view/videos?id=${route.params.id}`),
    ])
